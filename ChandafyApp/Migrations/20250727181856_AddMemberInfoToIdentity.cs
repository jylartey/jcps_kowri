...
{
    /// <inheritdoc />
    public partial class AddMemberInfoToIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Jamaat", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Jamaat_Circuit_CircuitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Jamaat_JamaatId",
                        column: x => x.JamaatId,
                        principalTable: "Jamaat",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Member_Jamaat_JamaatId",
                        column: x => x.JamaatId,
                        principalTable: "Jamaat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Circuit_ZoneId",
                table: "Circuit",
                column: "ZoneId");

            migrationBuilder.CreateIndex(
                name: "IX_Jamaat_CircuitId",
                table: "Jamaat",
                column: "CircuitId");
